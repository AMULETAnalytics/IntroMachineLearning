# File-Name:       Chapter_3.R           
# Date:            2015-10-10                                
# Author:          Daniel D. Gutierrez (daniel@amuletanalytics.com)
# Purpose:         Machine Learning and Data Science: code for Chapter 3 - Data Munging
...
ToothGrowth_df <- mutate(ToothGrowth_df, supp_num=as.numeric(supp))
...
cor(iris[,-5])   # Calculate correlation matrix without Species
